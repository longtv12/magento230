...
class Interceptor extends \Magento\Rma\Model\ResourceModel\Item implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAuthorizedItems');
        if (!$pluginInfo) {
            return parent::getAuthorizedItems($rmaId);
        } else {
            return $this->___callPlugins('getAuthorizedItems', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getReturnableItems');
        if (!$pluginInfo) {
            return parent::getReturnableItems($orderId);
        } else {
            return $this->___callPlugins('getReturnableItems', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOrderItemsCollection');
        if (!$pluginInfo) {
            return parent::getOrderItemsCollection($orderId);
        } else {
            return $this->___callPlugins('getOrderItemsCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOrderItems');
        if (!$pluginInfo) {
            return parent::getOrderItems($orderId, $parentId);
        } else {
            return $this->___callPlugins('getOrderItems', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductName($item)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductName($item);
        } else {
