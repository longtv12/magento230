...
class Interceptor extends \Magento\Reports\Model\ResourceModel\Customer\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCartInfo');
        if (!$pluginInfo) {
            return parent::addCartInfo();
        } else {
            return $this->___callPlugins('addCartInfo', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCustomerName');
        if (!$pluginInfo) {
            return parent::addCustomerName();
        } else {
            return $this->___callPlugins('addCustomerName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addOrdersStatistics');
        if (!$pluginInfo) {
            return parent::addOrdersStatistics($isFilter);
        } else {
            return $this->___callPlugins('addOrdersStatistics', func_get_args(), $pluginInfo);
        }
    }
