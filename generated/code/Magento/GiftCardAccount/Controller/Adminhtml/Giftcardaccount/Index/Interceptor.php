...
class Interceptor extends \Magento\GiftCardAccount\Controller\Adminhtml\Giftcardaccount\Index implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setShowCodePoolStatusMessage');
        if (!$pluginInfo) {
            return parent::setShowCodePoolStatusMessage($isShow);
        } else {
            return $this->___callPlugins('setShowCodePoolStatusMessage', func_get_args(), $pluginInfo);
        }
    }
